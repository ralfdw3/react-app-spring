...
public interface ForecastStub {
    ...
    static Forecast forecastWithStatusTempestade(){
        return new Forecast(1L, CityStub.cityDefault(), Weather.STORM, Shift.DAY, new BigDecimal("10"), new BigDecimal("20"), 85, 10, 20, LocalDate.now());
    }

    static Forecast forecastWithStatusNubladoNoite(){
        return new Forecast(1L, CityStub.cityDefault(), Weather.CLEAR, Shift.NIGHT, new BigDecimal("10"), new BigDecimal("20"), 60, 10, 10, LocalDate.now());
    }

    static Forecast forecastWithStatusNubladoDia(){
        return new Forecast(1L, CityStub.cityDefault(), Weather.CLEAR, Shift.DAY, new BigDecimal("10"), new BigDecimal("20"), 60, 10, 10, LocalDate.now());
    }
